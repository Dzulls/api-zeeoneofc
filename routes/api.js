...
var creatorList = ['@vcrun times','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'api-vcrun') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'api-vcrun') return res.json(loghandler.invalidKey)
